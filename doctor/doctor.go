...
var reNet = regexp.MustCompile(`((1\d\d|[1-9]\d|2[0-4]\d|\d|25[0-5])\.){3,3}(1\d\d|[1-9]\d|2[0-4]\d|\d|25[0-5])\/([1-2]\d|3[0-2]|[1-9])`)
var reIP = regexp.MustCompile(`((1\d\d|[1-9]\d|2[0-4]\d|\d|25[0-5])\.){3,3}(1\d\d|[1-9]\d|2[0-4]\d|\d|25[0-5])`)
